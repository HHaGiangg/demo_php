        ...
        <div class="container-pluid">
            <div class="container">
                ...
                <div class="col-md-3 box-footer" >
                    <h3 class="tittle-footer">Giang</h3>
                    <ul>
                        <li>
                ...
                <div class="col-md-3" id="footer-support">
                    ...
                    <ul>
                        <li>
                            <p><i class="fa fa-home" style="font-size: 16px;padding-right: 5px;"></i> Số Nhà 9 - Ngõ 18 - Đường Trần Tấn - Tp.Vinh - Nghệ An </p>
                            <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i> 0337302525</p>
                            <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i> hhgiang.17it2@sict.udn.vn</p>
                        </li>
                    </ul>
                </div>
            </div>
